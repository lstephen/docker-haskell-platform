...
RUN curl -sSL https://haskell.org/platform/download/$(cat /HASKELL_PLATFORM_VERSION)/haskell-platform-$(cat /HASKELL_PLATFORM_VERSION)-unknown-posix-x86_64.tar.gz | tar xz
